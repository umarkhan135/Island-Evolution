...
java -jar island/island.jar -altitude canyon -numOfCities 100 -s circle -beachWidth 2 -numOfAquifer 1 -numOfLakes 1 -temperature mild -percipitation tropical -o img/test2.mesh -i img/test.mesh
